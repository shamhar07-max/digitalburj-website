...
export function PageHero({ tag, title, sub, editorial, chips }: { tag: string; title: React.ReactNode; sub: string; editorial?: string; chips?: string[] }) {
  return (
    <section className="relative overflow-hidden border-b border-hair">
      <div aria-hidden className="pointer-events-none absolute inset-0 bg-glare opacity-60" />
      ...
      <div className="container-db relative pb-14 pt-14 sm:pt-20">
        ...
        <h1 className="font-display mt-7 max-w-4xl text-balance text-4xl font-extrabold leading-[1.04] tracking-tight text-ink sm:text-6xl [text-shadow:0_0_40px_rgba(255,107,61,0.16)]">{title}</h1>
