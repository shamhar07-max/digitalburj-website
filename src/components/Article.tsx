    ...
    <>
      ...
      <section className="border-b border-hair bg-panel-deep/50">
        <div className="container-db max-w-4xl py-10">
          ...
          <p className="mt-4 text-base leading-relaxed text-ink-soft" style={{ borderLeft: "4px solid #D9481C", paddingLeft: "1rem" }}>{excerpt}</p>
          {(date || reading) && (
      ...
      <section className="container-db max-w-3xl py-10">
        ...
        <div className="mt-12 rounded-2xl border-2 border-ink bg-panel p-7 text-center shadow-[6px_6px_0_#D9481C]">
