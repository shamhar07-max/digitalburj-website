    ...
    <section className="py-12 sm:py-14">
      <div className="relative overflow-hidden rounded-2xl border border-hair bg-panel-deep/90 px-6 py-16 text-center backdrop-blur-sm sm:px-16">
        ...
        <div className="relative">
          ...
          <h2 className="font-display mx-auto mt-4 max-w-2xl text-balance text-3xl font-extrabold leading-[1.06] tracking-tight text-ink sm:text-5xl [text-shadow:0_0_36px_rgba(255,107,61,0.16)]">{title}</h2>
