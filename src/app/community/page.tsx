...
export default function Community() {
  return (
    <>
      <PageHero tag="Community" title={<>Learn in the open. <span className="text-foil-gold">Get spotted doing real work.</span></>} sub="Weekly build logs, SME before-and-afters, method breakdowns, and open workshops. Free to join, earned to stand out." />
